...
### 1. NetworkContext ([contexts/NetworkContext.tsx](file:///d:/Sistemas/easytravel/mobile/contexts/NetworkContext.tsx))
...
### 2. Local Database ([services/localDb.ts](file:///d:/Sistemas/easytravel/mobile/services/localDb.ts))
...
### 3. API Layer ([services/api.ts](file:///d:/Sistemas/easytravel/mobile/services/api.ts))
...
### 4. Sync Service ([services/syncService.ts](file:///d:/Sistemas/easytravel/mobile/services/syncService.ts))
...
### CachedImage Component ([components/CachedImage.tsx](file:///d:/Sistemas/easytravel/mobile/components/CachedImage.tsx))
